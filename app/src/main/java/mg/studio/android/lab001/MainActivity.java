...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cb_eyebrows = findViewById(R.id.cb_eyebrow);
        cb_eyes = findViewById(R.id.cb_eye);
